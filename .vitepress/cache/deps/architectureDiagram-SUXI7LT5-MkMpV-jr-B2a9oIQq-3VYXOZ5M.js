...
// node_modules/vitepress-plugin-legend/dist/architectureDiagram-SUXI7LT5-MkMpV-jr-B2a9oIQq.js
var fe = { exports: {} };
var pe = { exports: {} };
var ve = { exports: {} };
var ui = ve.exports;
        ...
        (function(_) {
          ...
          function(_, k, T) {
            ...
            u.svd = function(d) {
              ...
              for (var q2 = r - 1, et = Math.pow(2, -52), vt = Math.pow(2, -966); r > 0; ) {
                  ...
                  case 4:
                    {
                      if (this.s[j] <= 0) {
                        ...
                        for (var st = 0; st <= q2; st++)
                          this.V[st][j] = -this.V[st][j];
                      }
                      for (; j < q2 && !(this.s[j] >= this.s[j + 1]); ) {
                        var It = this.s[j];
                        ...
                        if (j < this.m - 1)
                          for (var Ot2 = 0; Ot2 < this.m; Ot2++)
                            It = this.U[Ot2][j + 1], this.U[Ot2][j + 1] = this.U[Ot2][j], this.U[Ot2][j] = It;
                        j++;
                      }
                      r--;
                    }
            ...
            765: (
              ...
              ((o, i2, e2) => {
                ...
                x.prototype.newGraphManager = function() {
                  ...
                  var m = function D(b) {
                    for (var q2 = b.getChild().getNodes(), et, vt = 0, j = 0; j < q2.length; j++)
                      et = q2[j], et.getChild() == null ? r.fixedNodeSet.has(et.id) && (vt += 100) : vt += D(et);
                    return vt;
                  };
                    ...
                    if (l.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      this.shuffle = function(D) {
                        ...
                        for (et = D.length - 1; et >= 2 * D.length / 3; et--)
                          b = Math.floor(Math.random() * (et + 1)), q2 = D[et], D[et] = D[b], D[b] = q2;
                        return D;
                        ...
                        if (D.left) {
                          var b = M.has(D.left) ? M.get(D.left) : D.left, q2 = M.has(D.right) ? M.get(D.right) : D.right;
                          r.nodesInRelativeHorizontal.includes(b) || (r.nodesInRelativeHorizontal.push(b), r.nodeToRelativeConstraintMapHorizontal.set(b, []), r.dummyToNodeForVerticalAlignment.has(b) ? r.nodeToTempPositionMapHorizontal.set(b, r.idToNodeMap.get(r.dummyToNodeForVerticalAlignment.get(b)[0]).getCenterX()) : r.nodeToTempPositionMapHorizontal.set(b, r.idToNodeMap.get(b).getCenterX())), r.nodesInRelativeHorizontal.includes(q2) || (r.nodesInRelativeHorizontal.push(q2), r.nodeToRelativeConstraintMapHorizontal.set(q2, []), r.dummyToNodeForVerticalAlignment.has(q2) ? r.nodeToTempPositionMapHorizontal.set(q2, r.idToNodeMap.get(r.dummyToNodeForVerticalAlignment.get(q2)[0]).getCenterX()) : r.nodeToTempPositionMapHorizontal.set(q2, r.idToNodeMap.get(q2).getCenterX())), r.nodeToRelativeConstraintMapHorizontal.get(b).push({ right: q2, gap: D.gap }), r.nodeToRelativeConstraintMapHorizontal.get(q2).push({ left: b, gap: D.gap });
                        } else {
                      ...
                      this.constraints.relativePlacementConstraint.forEach(function(D) {
                        if (D.left) {
                          var b = M.has(D.left) ? M.get(D.left) : D.left, q2 = M.has(D.right) ? M.get(D.right) : D.right;
                          z.has(b) ? z.get(b).push(q2) : z.set(b, [q2]), z.has(q2) ? z.get(q2).push(b) : z.set(q2, [b]);
                        } else {
                          var et = C.has(D.top) ? C.get(D.top) : D.top, vt = C.has(D.bottom) ? C.get(D.bottom) : D.bottom;
                      ...
                      var B = function(D, b) {
                        var q2 = [], et = [], vt = new Z(), j = /* @__PURE__ */ new Set(), Dt = 0;
                        return D.forEach(function(J, nt) {
                          if (!j.has(nt)) {
                            q2[Dt] = [], et[Dt] = false;
                            var mt = nt;
                            for (vt.push(mt), j.add(mt), q2[Dt].push(mt); vt.length != 0; ) {
                              mt = vt.shift(), b.has(mt) && (et[Dt] = true);
                              var ht = D.get(mt);
                              ht.forEach(function(_t) {
                                j.has(_t) || (vt.push(_t), j.add(_t), q2[Dt].push(_t));
                              });
                            }
                            Dt++;
                          }
                        }), { components: q2, isFixed: et };
                    ...
                    if (l.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      this.totalIterations % 10 == 0 && (this.shuffle(this.nodesInRelativeHorizontal), this.shuffle(this.nodesInRelativeVertical)), this.nodesInRelativeHorizontal.forEach(function(G) {
                        if (!r.fixedNodesOnHorizontal.has(G)) {
                          ...
                          r.dummyToNodeForVerticalAlignment.has(G) ? D = r.idToNodeMap.get(r.dummyToNodeForVerticalAlignment.get(G)[0]).displacementX : D = r.idToNodeMap.get(G).displacementX, r.nodeToRelativeConstraintMapHorizontal.get(G).forEach(function(b) {
                            if (b.right) {
                              var q2 = r.nodeToTempPositionMapHorizontal.get(b.right) - r.nodeToTempPositionMapHorizontal.get(G) - D;
                              q2 < b.gap && (D -= b.gap - q2);
                            } else {
                              var q2 = r.nodeToTempPositionMapHorizontal.get(G) - r.nodeToTempPositionMapHorizontal.get(b.left) + D;
                              q2 < b.gap && (D += b.gap - q2);
                            }
                        ...
                        if (!r.fixedNodesOnHorizontal.has(G)) {
                          ...
                          r.dummyToNodeForHorizontalAlignment.has(G) ? D = r.idToNodeMap.get(r.dummyToNodeForHorizontalAlignment.get(G)[0]).displacementY : D = r.idToNodeMap.get(G).displacementY, r.nodeToRelativeConstraintMapVertical.get(G).forEach(function(b) {
                            if (b.bottom) {
                              var q2 = r.nodeToTempPositionMapVertical.get(b.bottom) - r.nodeToTempPositionMapVertical.get(G) - D;
                              q2 < b.gap && (D -= b.gap - q2);
                            } else {
                              var q2 = r.nodeToTempPositionMapVertical.get(G) - r.nodeToTempPositionMapVertical.get(b.top) + D;
                              q2 < b.gap && (D += b.gap - q2);
                            }
                      ...
                      for (var p = 0; p < this.componentsOnVertical.length; p++) {
                        ...
                        if (this.fixedComponentsOnVertical[p])
                          for (var m = 0; m < U.length; m++)
                            this.dummyToNodeForHorizontalAlignment.has(U[m]) ? this.dummyToNodeForHorizontalAlignment.get(U[m]).forEach(function(q2) {
                              r.idToNodeMap.get(q2).displacementY = 0;
                  ...
                  if (v == r[1].source ? p = r[1].target : p = r[1].source, l.PURE_INCREMENTAL)
                    ...
                    for (var G = P.MAX_VALUE, D, b, q2 = 0; q2 < B.length; q2++)
                      B[q2] < G ? (G = B[q2], D = 1, b = q2) : B[q2] == G && D++;
                    if (D == 3 && G == 0)
              ...
              ((o, i2, e2) => {
                ...
                l.handleConstraints = function(g) {
                  ...
                  var H = function(L, R) {
                    ...
                    function pt(dt, at) {
                      var st = new Set(dt), It = true, ut = false, Ot2 = void 0;
                      try {
                        ...
                        if (tt.get(st.id) < tt.get(dt) + st.gap)
                          if (V && V.has(st.id)) {
                            ...
                            if (R == "horizontal" ? It = c.has(st.id) ? y[c.get(st.id)] : Q.get(st.id) : It = c.has(st.id) ? A[c.get(st.id)] : Q.get(st.id), tt.set(st.id, It), It < tt.get(dt) + st.gap) {
                              ...
                              gt.get(dt).forEach(function(Ot2) {
                                tt.set(Ot2, tt.get(Ot2) - ut);
                              });
                            }
                          } else
                    ...
                    if (V) {
                      ...
                      gt.forEach(function(dt, at) {
                        if (yt.has(at)) {
                          var st = false, It = true, ut = false, Ot2 = void 0;
                          try {
                        ...
                        var st = Number.POSITIVE_INFINITY, It = Number.POSITIVE_INFINITY, ut = Number.NEGATIVE_INFINITY, Ot2 = Number.NEGATIVE_INFINITY, Ut = true, Lt = false, At = void 0;
                        try {
                          for (var Ht = dt[Symbol.iterator](), Yt; !(Ut = (Yt = Ht.next()).done); Ut = true) {
                            ...
                            var Zt = tt.get(Rt);
                            kt < st && (st = kt), kt > ut && (ut = kt), Zt < It && (It = Zt), Zt > Ot2 && (Ot2 = Zt);
                          }
                        } catch (Kt) {
                          Lt = true, At = Kt;
                        } finally {
                        ...
                        var he = (st + ut) / 2 - (It + Ot2) / 2, re = true, Qt = false, Jt = void 0;
                        try {
                  ...
                  if (h.fixedNodeConstraint && h.fixedNodeConstraint.forEach(function(L) {
                    ...
                    if (h.fixedNodeConstraint && h.fixedNodeConstraint.length > 1)
                      ...
                      if (W < U.size / 2)
                        ...
                        var q2 = x(G, "horizontal"), et = x(D, "vertical");
                        z[B].forEach(function(L, R) {
                          m[R] = [y[c.get(L)], A[c.get(L)]], v[R] = [], q2.has(L) ? v[R][0] = q2.get(L) : v[R][0] = y[c.get(L)], et.has(L) ? v[R][1] = et.get(L) : v[R][1] = A[c.get(L)];
                        }), O = true;
                      }
                    }
                    if (O) {
                  ...
                  if (n.ENFORCE_CONSTRAINTS) {
                    ...
                    h.relativePlacementConstraint && (function() {
                      ...
                      }, ut = true, Ot2 = false, Ut = void 0;
                      try {
                        for (var Lt = F.keys()[Symbol.iterator](), At; !(ut = (At = Lt.next()).done); ut = true) {
                          var Ht = At.value;
                          It(Ht);
                        }
                      } catch (ft) {
                ...
                var s = e2(548), n = e2(140).CoSELayout, f = e2(140).CoSENode, t = e2(140).layoutBase.PointD, a = e2(140).layoutBase.DimensionD, l = e2(140).layoutBase.LayoutConstants, g = e2(140).layoutBase.FDLayoutConstants, h = e2(140).CoSEConstants, N = function(c, y) {
                  ...
                  var ot = function(C) {
                    ...
                    for (var B = U.length, $ = 0; $ < B; $++) {
                      ...
                      var b = void 0, q2 = G.layoutDimensions({
                        nodeDimensionsIncludeLabels: W.nodeDimensionsIncludeLabels
                      });
                      if (G.outerWidth() != null && G.outerHeight() != null)
                        if (W.randomize)
                          if (!G.isParent())
                            b = F.add(new f(z.graphManager, new t(H[S.get(G.id())] - q2.w / 2, Z[S.get(G.id())] - q2.h / 2), new a(parseFloat(q2.w), parseFloat(q2.h))));
                          else {
                            var et = s.calcBoundingBox(G, H, Z, S);
                            G.intersection(E).length == 0 ? b = F.add(new f(z.graphManager, new t(et.topLeftX, et.topLeftY), new a(et.width, et.height))) : b = F.add(new f(z.graphManager, new t(et.topLeftX, et.topLeftY), new a(parseFloat(q2.w), parseFloat(q2.h))));
                          }
                        else
                          b = F.add(new f(z.graphManager, new t(G.position("x") - q2.w / 2, G.position("y") - q2.h / 2), new a(parseFloat(q2.w), parseFloat(q2.h))));
                      else
                    ...
                    value: function() {
                      ...
                      if (P.layoutUtilities && I.packComponents && (r = P.layoutUtilities("get"), r || (r = P.layoutUtilities()), E = true), Y.nodes().length > 0)
                        if (E) {
                          ...
                          var q2 = I.eles.boundingBox();
                          if (x.push({ x: q2.x1 + q2.w / 2, y: q2.y1 + q2.h / 2 }), I.randomize) {
                            var et = l(I);
                            S.push(et);
                          }
            ...
            657: (
              ...
              ((o, i2, e2) => {
                var s = e2(548), n = e2(140).layoutBase.Matrix, f = e2(140).layoutBase.SVD, t = function(a) {
                  ...
                  try {
                    for (var q2 = c.keys()[Symbol.iterator](), et; !(G = (et = q2.next()).done); G = true) {
                      var vt = et.value;
                      y.set(vt, B++);
                    }
                  } catch (ct) {
                  ...
                  if (r > 2) {
                    ...
                    for (var Wt = 0; Wt < M; Wt++)
                      ot[Wt] = [];
                    return a.quality == "draft" || a.step == "all" ? (U(m), z(), W(), Tt = { nodeIndexes: y, xCoords: P, yCoords: Y }) : (y.forEach(function(ct, L) {
...
var Re = {
  L: q((w) => `${w},${w / 2} 0,${w} 0,0`, "L"),
  R: q((w) => `0,${w / 2} ${w},0 ${w},${w}`, "R"),
  T: q((w) => `0,0 ${w},0 ${w / 2},${w}`, "T"),
  B: q((w) => `${w / 2},0 ${w},${w} 0,${w}`, "B")
};
var ae = {
  L: q((w, X) => w - X + 2, "L"),
  R: q((w, X) => w - 2, "R"),
...
var me = q(function(w, X) {
  const _ = `${w}${X}`;
  return wi(_) ? _ : void 0;
}, "getArchitectureDirectionPair");
var Ii = q(function([w, X], _) {
  const k = _[0], T = _[1];
...
var Fe = q((w) => w.data(), "edgeData");
var ie = q((w) => w.data(), "nodeData");
var Se = wU.architecture;
var Et = new e(() => ({
  nodes: {},
  groups: {},
  edges: [],
...
var Oi = q(() => Object.values(Et.records.nodes).filter(Mi), "getServices");
var Ri = q(function({ id: w, in: X }) {
  Et.records.registeredIds[w] = "node", Et.records.nodes[w] = {
    id: w,
    type: "junction",
    edges: [],
...
var bi = q(() => Object.values(Et.records.nodes).filter(xi), "getJunctions");
var Pi = q(() => Object.values(Et.records.nodes), "getNodes");
var ye = q((w) => Et.records.nodes[w], "getNode");
var Gi2 = q(function({ id: w, icon: X, in: _, title: k }) {
  if (Et.records.registeredIds[w] !== void 0)
    throw new Error(
...
var Fi = q(() => Object.values(Et.records.groups), "getGroups");
var Si = q(function({
  lhsId: w,
  rhsId: X,
  lhsDir: _,
...
var Ui = q(() => Et.records.edges, "getEdges");
var ki = q(() => {
...
var Xi = q((w) => Et.records.elements[w], "getElementById");
var Ue = q(() => o_({
  ...Se,
  ...Gi().architecture
}), "getConfig");
...
`, "getStyles");
var zi = Wi;
var ee = q((w) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${w}</g>`, "wrapIcon");
var ne = {
    ...
    X.nodes().map(async (u) => {
      ...
      if (d.type === "group") {
        ...
        if (d.icon) {
          const a = n.append("g");
          a.html(
            `<g>${await Nf(d.icon, { height: _, width: _, fallbackPrefix: ne.prefix })}</g>`
          ), a.attr(
            "transform",
...
var qi = q(async function(w, X, _) {
  for (const k of _) {
    ...
    if (k.icon)
      d.html(
        `<g>${await Nf(k.icon, { height: u, width: u, fallbackPrefix: ne.prefix })}</g>`
      );
    else if (k.iconText) {
      d.html(
        `<g>${await Nf("blank", { height: u, width: u, fallbackPrefix: ne.prefix })}</g>`
      );
...
q(Be, "addEdges");
function We(w, X, _) {
  const k = q((o, i2) => Object.entries(o).reduce(
    (e2, [s, n]) => {
      let f = 0;
...
q(We, "getAlignments");
function ze(w) {
  const X = [], _ = q((T) => `${T[0]},${T[1]}`, "posToStr"), k = q((T) => T.split(",").map((u) => parseInt(u)), "strToPos");
  return w.forEach((T) => {
...
q(ze, "getRelativeConstraints");
function Ve(w, X, _, k, T, { spatialMaps: u, groupAlignments: d }) {
  return new Promise((o) => {
    const i2 = bn("body").append("div").attr("id", "cy").attr("style", "display:none"), e2 = Jn({
    ...
    f.one("layoutstop", () => {
      ...
      q(t, "getSegmentWeights"), e2.startBatch();
      ...
      Ot.info("Ready", t), o(e2);
    });
  });
}
q(Ve, "layoutArchitecture");
var Ki = q(async (w, X, _, k) => {
  const T = k.db, u = T.getServices(), d = T.getJunctions(), o = T.getGroups(), i2 = T.getEdges(), e2 = T.getDataStructures(), s = s$t(X), n = s.append("g");
  ...
  await Vi(n, a), await ji(t, a), Xe(T, a), Rvt(void 0, s, Ft("padding"), Ft("useMaxWidth"));
}, "draw");
var Zi = { draw: Ki };
var rr = {
  parser: Bi,
...
//# sourceMappingURL=architectureDiagram-SUXI7LT5-MkMpV-jr-B2a9oIQq-3VYXOZ5M.js.map
