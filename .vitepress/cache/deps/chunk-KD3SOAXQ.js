...
// node_modules/vitepress-plugin-legend/dist/mermaid-parser.core-BppQlyDy-CESsuAun.js
var Oc = Object.prototype;
var _c = Oc.hasOwnProperty;
var Ae = m8t(function(r, e) {
  if (v2(e) || x2(e)) {
    V7t(e, A(e), r);
    return;
  }
  for (var t in e)
    _c.call(e, t) && U7t(r, t, e[t]);
});
function wl(r, e, t) {
  var n2 = -1, i = r.length;
...
var qn = p8t(function(r, e) {
  return s7t(r) ? Uc(r, wa(e, 1, s7t, true)) : [];
});
function J(r, e, t) {
...
var jc = Dc(function(r, e, t) {
  Vc.call(r, t) ? r[t].push(e) : ZC(r, t, [e]);
});
var Hc = "[object String]";
function he(r) {
  return typeof r == "string" || !km(r) && Lf(r) && Ah(r) == Hc;
}
var Wc = Math.max;
function de(r, e, t, n2) {
  r = x2(r) ? r : ma(r), t = t ? U(t) : 0;
  var i = r.length;
...
function us(r) {
  ...
  return e && e.atLeast === 0 ? true : r.value ? km(r.value) ? _e(r.value, us) : us(r.value) : false;
}
...
`],
  ...
  t("misc mapping", () => {
    a = lr(n2, ($) => $.tokenTypeIdx), o = lr(n2, ($) => {
      ...
      const T = $.LONGER_ALT;
      if (T)
        return km(T) ? lr(T, (I) => ya(n2, I)) : [ya(n2, T)];
...
function Tf(r, e) {
  ...
  return t = t.concat(i.errors), t = t.concat(vf(s)), t = t.concat(Nf(s)), t = t.concat(wf(s, e)), t = t.concat(Lf2(s)), t;
}
function vf(r) {
  let e = [];
...
function $f(r) {
  const e = Aa(r, (i) => {
    const s = i[Tt];
    return !Xe(s) && !KC(s) && !cr(s, "exec") && !he(s);
  }), t = lr(e, (i) => ({
...
`,
        ...
        const l = km(a.LONGER_ALT) ? a.LONGER_ALT : [a.LONGER_ALT];
        _a(l, (u) => {
          !Oa(u) && !de(i, u) && n2.push({
...
function Bf(r) {
  ...
  for (; n2; ) {
    ...
    const i = qn(t, e);
    e = e.concat(i), ZL(i) ? n2 = false : t = i;
  }
  return e;
}
function Kf(r) {
  _a(r, (e) => {
    uu(e) || (ou[Ca] = e, e.tokenTypeIdx = Ca++), Na(e) && !km(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]), Na(e) || (e.CATEGORIES = []), Hf(e) || (e.categoryMatches = []), Wf(e) || (e.categoryMatchesMap = {});
  });
}
function Vf(r) {
  _a(r, (e) => {
...
a boolean 2nd argument is no longer supported`);
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
        ...
        this.trackStartLines = /full|onlyStart/i.test(this.config.positionTracking), this.trackEndLines = /full/i.test(this.config.positionTracking), km(e) ? i = {
      ...
      }), this.defaultMode = i.defaultMode, !ZL(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling) {
...
` + o);
      ...
      _a(this.lexerDefinitionWarning, (o) => {
        ...
        if (nu ? (this.chopInput = CX, this.match = this.matchWithTest) : (this.updateLastIndex = Tr, this.match = this.matchWithExec), s && (this.handleModes = Tr), this.trackStartLines === false && (this.computeNewColumn = CX), this.trackEndLines === false && (this.updateTokenEndLineColumnLocation = Tr), /full/i.test(this.config.positionTracking))
  ...
  tokenize(e, t = this.defaultMode) {
    if (!ZL(this.lexerDefinitionErrors)) {
...
var Zf = class extends ti {
  ...
  updateExpectedNext() {
    ZL(this.ruleStack) ? (this.nextProductionName = "", this.nextProductionOccurrence = 0, this.isAtEndOfPath = true) : (this.nextProductionName = this.ruleStack.pop(), this.nextProductionOccurrence = this.occurrenceStack.pop());
  }
};
    ...
    if (o instanceof re)
      ...
      if (o instanceof ge)
        return _a(o.definition, (l) => {
          ZL(l.definition) === false && (n2 = a(l.definition));
        }), n2;
      if (o instanceof F)
...
function oh(r, e, t) {
  ...
  if (n2 && !t) {
    const s = er(r);
    if (s.length === 1 && ZL(s[0].categoryMatches)) {
...
function gu(r) {
  return _e(r, (e) => _e(e, (t) => _e(t, (n2) => ZL(n2.categoryMatches))));
}
function dh(r) {
...
function vh(r, e, t) {
  ...
  return i = Xn(i, (s) => s.ignoreAmbiguities === true), Ee(i, (s) => {
    const a = s.idx, o = s.maxLookahead || e, l = ii(a, r, o, s), u = Ah2(l, s, r, t), c = kh(l, s, r, t);
    return u.concat(c);
  });
}
...
var bh = class {
  ...
  canRecoverWithSingleTokenInsertion(e, t) {
    if (!this.canTokenTypeBeInsertedInRecovery(e) || ZL(t))
      return false;
    const n2 = this.LA(1);
...
function Hh(r, e) {
  const t = Aa(e, (i) => KC(r[i]) === false), n2 = lr(t, (i) => ({
...
var qh = class {
  initRecognizerEngine(e, t) {
    ...
    const n2 = cr(e, "modes") ? er(ma(e.modes)) : ma(e), i = _e(n2, (s) => ZL(s.categoryMatches));
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
  ...
  orInternal(e, t) {
    const n2 = this.getKeyForAutomaticLookahead(Iu, t), i = km(e) ? e : e.DEF, s = this.getLaFuncFromCache(n2).call(this, i);
    if (s !== void 0)
...
function Ht(r, e, t, n2 = false) {
  _n(t);
  const i = fr(this.recordingProdStack), s = KC(e) ? e : e.DEF, a = new r({ definition: [], idx: t });
...
function ep(r, e) {
  _n(e);
  const t = fr(this.recordingProdStack), n2 = km(r) === false, i = n2 === false ? r : r.DEF, s = new ge({
    definition: [],
    idx: e,
    ignoreAmbiguities: n2 && r.IGNORE_AMBIGUITIES === true
  });
  cr(r, "MAX_LOOKAHEAD") && (s.maxLookahead = r.MAX_LOOKAHEAD);
  const a = Ll(i, (o) => KC(o.GATE));
  ...
  performSelfAnalysis() {
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      if (this.TRACE_INIT("Grammar Resolving", () => {
        ...
        if (ZL(n2) && this.skipValidations === false) {
          const i = Sh({
            rules: ma(this.gastProductionsCache),
      ...
      }), ZL(this.definitionErrors) && (this.recoveryEnabled && this.TRACE_INIT("computeAllProdsFollows", () => {
      ...
      })), !_Gr.DEFER_DEFINITION_ERRORS_HANDLING && !ZL(this.definitionErrors))
...
var kp = class extends ta {
  ...
  buildLookaheadForOptional(e) {
    ...
    if (qa(c) && c[0][0] && !s) {
      const d = c[0], f = er(d);
      if (f.length === 1 && ZL(f[0].categoryMatches)) {
...
var Gm = class {
  constructor(e) {
    this.symbolIndex = /* @__PURE__ */ new Map(), this.symbolByTypeIndex = new km2(), this.referenceIndex = /* @__PURE__ */ new Map(), this.documents = e.workspace.LangiumDocuments, this.serviceRegistry = e.ServiceRegistry, this.astReflection = e.AstReflection;
  }
...
var xy = {
  info: v(async () => {
    const { createInfoServices: r } = await import("./info-63CPKGFF-DZeTg6Sj-Dmm8VQX5-HXRYRZUL.js"), e = r().Info.parser.LangiumParser;
    He.info = e;
  }, "info"),
  packet: v(async () => {
    const { createPacketServices: r } = await import("./packet-HUATNLJX-98_D1O5E-B0rsbr6C-3MTZSVSW.js"), e = r().Packet.parser.LangiumParser;
    He.packet = e;
  }, "packet"),
  pie: v(async () => {
    const { createPieServices: r } = await import("./pie-WTHONI2E-D337kPVJ-BqZEjkHI-3DXAP5H3.js"), e = r().Pie.parser.LangiumParser;
    He.pie = e;
  }, "pie"),
  architecture: v(async () => {
    const { createArchitectureServices: r } = await import("./architecture-O4VJ6CD3-cxLk0nJU-Bc1rt-t5-NA26VNF5.js"), e = r().Architecture.parser.LangiumParser;
    He.architecture = e;
  }, "architecture"),
  gitGraph: v(async () => {
    const { createGitGraphServices: r } = await import("./gitGraph-ZV4HHKMB-CLarli0n-C7k0PqFJ-7T3EAJ3Z.js"), e = r().GitGraph.parser.LangiumParser;
    He.gitGraph = e;
  }, "gitGraph"),
  radar: v(async () => {
    const { createRadarServices: r } = await import("./radar-NJJJXTRR-CqNCNvUs-DrpSItfc-RZDU6HLR.js"), e = r().Radar.parser.LangiumParser;
    He.radar = e;
  }, "radar"),
  treemap: v(async () => {
    const { createTreemapServices: r } = await import("./treemap-75Q7IDZK-CjtfQE8u-DBGEKm3F-SNM7NPHP.js"), e = r().Treemap.parser.LangiumParser;
    He.treemap = e;
  }, "treemap")
};
...
//# sourceMappingURL=chunk-KD3SOAXQ.js.map
