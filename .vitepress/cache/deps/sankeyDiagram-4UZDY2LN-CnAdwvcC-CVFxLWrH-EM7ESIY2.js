...
// node_modules/vitepress-plugin-legend/dist/sankeyDiagram-4UZDY2LN-CnAdwvcC-CVFxLWrH.js
function Pt(t) {
...
var at = (function() {
  var t = q(function(m, i, o, f) {
    ...
    performAction: q(function(m, i, o, f, p, y, w) {
      var k = y.length - 1;
      switch (p) {
        case 7:
...
` + this.showPosition(), {
      ...
      performAction: q(function(i, o, f, p) {
        switch (f) {
          case 0:
  ...
  return q(_, "Parser"), _.prototype = c, c.Parser = _, new _();
})();
at.parser = at;
var Z = at;
var B = [];
...
var oe = {
  nodesMap: K,
  getConfig: q(() => An().sankey, "getConfig"),
  getNodes: ie,
  getLinks: re,
  getGraph: se,
  addLink: te,
...
var le = q(function(t, n, r, a) {
  const { securityLevel: c, sankey: b } = An(), _ = ole.sankey;
  let m;
  c === "sandbox" && (m = bn("#i" + n));
  const i = c === "sandbox" ? bn(m.nodes()[0].contentDocument.body) : bn("body"), o = c === "sandbox" ? i.select(`[id="${n}"]`) : bn(`[id="${n}"]`), f = b?.width ?? _.width, p = b?.height ?? _.width, y = b?.useMaxWidth ?? _.useMaxWidth, w = b?.nodeAlignment ?? _.nodeAlignment, k = b?.prefix ?? _.prefix, O = b?.suffix ?? _.suffix, A = b?.showValues ?? _.showValues, T = a.db.getGraph(), D = ae[w];
...
${k}${Math.round(L * 100) / 100}${O}` : g2, "getText");
  ...
  switch (I) {
    case "gradient":
      C = q((g2) => g2.uid, "coloring");
      break;
    case "source":
      C = q((g2) => P(g2.source.id), "coloring");
      break;
    case "target":
      C = q((g2) => P(g2.target.id), "coloring");
      break;
    default:
      C = I;
  }
  N.append("path").attr("d", Bt()).attr("stroke", C).attr("stroke-width", (g2) => Math.max(1, g2.width)), Rvt(void 0, o, 0, y);
}, "draw");
var ce = {
  draw: le
};
var he = q((t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
...
//# sourceMappingURL=sankeyDiagram-4UZDY2LN-CnAdwvcC-CVFxLWrH-EM7ESIY2.js.map
