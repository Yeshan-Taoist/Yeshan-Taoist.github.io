...
// node_modules/vitepress-plugin-legend/dist/layout-FfY8zw-4-CVLJrweZ.js
function Qn(n) {
  return f8t(s8t(n, void 0, er), n + "");
}
var Un = 1;
var Xn = 4;
function Wn(n) {
...
function y2(n) {
  return n && n.length ? ar(n, CX, er2) : void 0;
}
function Z(n, r) {
...
function fr2(n) {
  return function(r, e, t) {
    return t && typeof t != "number" && g8t(r, e, t) && (e = t = void 0), r = R(r), e === void 0 ? (e = r, r = 0) : e = R(e), t = t === void 0 ? r < e ? 1 : -1 : R(t), sr2(r, e, t);
  };
}
var E2 = fr2();
var R2 = p8t(function(n, r) {
  if (n == null)
    return [];
  var e = r.length;
  return e > 1 && g8t(n, r[0], r[1]) ? r = [] : e > 2 && g8t(r[0], r[1], r[2]) && (r = [r[0]]), ar2(n, wa(r), []);
});
var hr2 = 0;
function H(n) {
  var r = ++hr2;
...
function Ie(n) {
  var r = S(n), e = y8t(we(n, r), me(n, r)), t = {}, o;
  _a(["u", "d"], function(a) {
...
//# sourceMappingURL=chunk-Y2MQYAZE.js.map
