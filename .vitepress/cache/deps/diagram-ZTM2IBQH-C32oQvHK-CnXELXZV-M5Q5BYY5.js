...
// node_modules/vitepress-plugin-legend/dist/diagram-ZTM2IBQH-C32oQvHK-CnXELXZV.js
var x = {
  showLegend: true,
  ticks: 5,
  max: null,
...
var C = q(() => h.axes, "getAxes");
var J = q(() => h.curves, "getCurves");
var X = q(() => h.options, "getOptions");
var Z = q((a) => {
  h.axes = a.map((t) => ({
    name: t.name,
...
var tt = q((a, t, e, r) => {
  const s = r.db, n = s.getAxes(), o = s.getCurves(), i2 = s.getOptions(), c = s.getConfig(), d = s.getDiagramTitle(), u = s$t(t), g = et(u, c), p = i2.max ?? Math.max(...o.map((y) => Math.max(...y.entries))), m = i2.min, $ = Math.min(c.width, c.height) / 2;
...
var nt = q((a) => {
  const t = gvt(), e = Gi(), r = o_(t, e.themeVariables), s = o_(r.radar, a);
...
//# sourceMappingURL=diagram-ZTM2IBQH-C32oQvHK-CnXELXZV-M5Q5BYY5.js.map
