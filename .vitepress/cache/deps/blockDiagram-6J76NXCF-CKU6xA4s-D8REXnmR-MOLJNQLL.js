...
import {
  n
} from "./chunk-Q2Q5HNLZ.js";
import "./chunk-ATKLFEBH.js";
import {
  l
} from "./chunk-MGSJO7W2.js";
import {
  e
} from "./chunk-H5TWWNGH.js";
import {
  An,
  FC,
  Gi,
...
// node_modules/vitepress-plugin-legend/dist/blockDiagram-6J76NXCF-CKU6xA4s-D8REXnmR.js
var xt = (function() {
  var e2 = q(function(v, c, p, w) {
    ...
    performAction: q(function(v, c, p, w, E, d, _) {
      var y2 = d.length - 1;
      switch (E) {
        case 4:
        ...
        case 23:
          ...
          const q2 = w.edgeStrToEdgeData(d[y2 - 1].edgeTypeStr);
          this.$ = [
            { id: d[y2 - 2].id, label: d[y2 - 2].label, type: d[y2 - 2].type, directions: d[y2 - 2].directions },
            { id: d[y2 - 2].id + "-" + d[y2].id, start: d[y2 - 2].id, end: d[y2].id, label: d[y2 - 1].label, type: "edge", directions: d[y2].directions, arrowTypeEnd: q2, arrowTypeStart: "arrow_open" },
    ...
    parse: q(function(v) {
      var c = this, p = [0], w = [], E = [null], d = [], _ = this.table, y2 = "", A = 0, O = 0, q2 = 2, j = 1, ie = d.slice.call(arguments, 1), z = Object.create(this.lexer), V = { yy: {} };
      ...
      for (var P, G, X, ut, J = {}, at, Z, vt, st; ; ) {
        if (G = p[p.length - 1], this.defaultActions[G] ? X = this.defaultActions[G] : ((P === null || typeof P > "u") && (P = Dt()), X = _[G] && _[G][P]), typeof X > "u" || !X.length || !X[0]) {
          ...
          st = [];
          for (at in _[G])
            this.terminals_[at] && at > q2 && st.push("'" + this.terminals_[at] + "'");
...
` + this.showPosition(), {
      ...
      options: {},
      performAction: q(function(c, p, w, E) {
        switch (w) {
          case 0:
            return 10;
          case 1:
  ...
  return q(D, "Parser"), D.prototype = k, k.Parser = D, new D();
})();
xt.parser = xt;
var ke = xt;
...
var De = q((e2) => Mh.sanitizeText(e2, Ee), "sanitizeText");
var ve = q(function(e2, t = "") {
  let a = lt.get(e2);
...
var Ne = q(function(e2, t = "") {
  const a = F.get(e2);
  t != null && (a.styles = t.split(Pt));
}, "addStyle2Node");
var $e = q(function(e2, t) {
  e2.split(",").forEach(function(a) {
    let n2 = F.get(a);
    if (n2 === void 0) {
      const i = a.trim();
      n2 = { id: i, type: "na", children: [] }, F.set(i, n2);
    }
...
var Yt = q((e2, t) => {
  ...
  for (const i of a) {
    ...
    if (i.type === "column-setting")
      ...
      const r = F.get(i.id);
      if (r === void 0 ? F.set(i.id, i) : (i.type !== "na" && (r.type = i.type), i.label !== i.id && (r.label = i.label)), i.children && Yt(i.children, i), i.type === "space") {
        const s = i.width ?? 1;
        for (let l2 = 0; l2 < s; l2++) {
          const o = n(i);
          o.id = o.id + "-" + l2, F.set(o.id, o), n2.push(o);
        }
...
var Te = q(() => {
  Ot.debug("Clear called"), Wvt(), et = { id: "root", type: "composite", children: [], columns: -1 }, F = /* @__PURE__ */ new Map([["root", et]]), St = [], lt = /* @__PURE__ */ new Map(), Lt = [], bt = /* @__PURE__ */ new Map();
}, "clear");
function Wt(e2) {
  switch (Ot.debug("typeStr2Type", e2), e2) {
    case "[]":
      return "square";
    case "()":
      return Ot.debug("we have a round"), "round";
    case "(())":
      return "circle";
    case ">]":
...
q(Kt, "edgeStrToEdgeData");
var Ct = 0;
var Ce = q(() => (Ct++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Ct), "generateId");
var Ie = q((e2) => {
...
var Oe = q(() => [...F.values()], "getBlocksFlat");
var ze = q(() => St || [], "getBlocks");
var Re = q(() => Lt, "getEdges");
var Ae = q((e2) => F.get(e2), "getBlock");
var Me = q((e2) => {
  F.set(e2.id, e2);
}, "setBlock");
var Pe = q(() => Ot, "getLogger");
var Ye = q(function() {
  return lt;
}, "getClasses");
var We = {
  getConfig: q(() => Gi().block, "getConfig"),
  typeStr2Type: Wt,
  edgeTypeStr2Type: Xt,
...
function ot(e2, t, a = 0, n2 = 0) {
  ...
  if (e2.children?.length > 0) {
    for (const b of e2.children)
      ot(b, t);
    const s = ar(e2);
    i = s.width, r = s.height, Ot.debug("setBlockSizes abc95 maxWidth of", e2.id, ":s children is ", i, r);
    for (const b of e2.children)
      b.size && (Ot.debug(
        `abc95 Setting size of children of ${e2.id} id=${b.id} ${i} ${r} ${JSON.stringify(b.size)}`
      ), b.size.width = i * (b.widthInColumns ?? 1) + C * ((b.widthInColumns ?? 1) - 1), b.size.height = r, b.size.x = 0, b.size.y = 0, Ot.debug(
    ...
    if (x < a) {
      ...
      Ot.debug("Size indata abc88", e2.id, "childWidth", b, "maxWidth", i), Ot.debug("Size indata abc88", e2.id, "childHeight", L, "maxHeight", r), Ot.debug("Size indata abc88 xSize", u, "padding", C);
    ...
    if (Ot.debug(
      ...
      if (b > 0) {
        const L = (x - b * C - C) / b;
        Ot.debug("abc95 (growing to fit) width", e2.id, x, e2.size?.width, L);
        for (const S of e2.children)
...
function kt(e2, t) {
  ...
  if (Ot.debug("layoutBlocks columns abc95", e2.id, "=>", a, e2), e2.children && // find max width of children
  e2.children.length > 0) {
    const n2 = e2?.children[0]?.size?.width ?? 0, i = e2.children.length * n2 + (e2.children.length - 1) * C;
    Ot.debug("widthOfChildren 88", i, "posX");
    let r = 0;
    Ot.debug("abc91 block?.size?.x", e2.id, e2?.size?.x);
    ...
    for (const o of e2.children) {
      ...
      if (b != l2 && (l2 = b, s = e2?.size?.x ? e2?.size?.x + (-e2?.size?.width / 2 || 0) : -C, Ot.debug("New row in layout for block", e2.id, " and child ", o.id, l2)), Ot.debug(
        `abc89 layout blocks (child) id: ${o.id} Pos: ${r} (px, py) ${f},${b} (${u?.size?.x},${u?.size?.y}) parent: ${u.id} width: ${h}${C}`
      ), u.size) {
        const L = h / 2;
        o.size.x = s + C + L, Ot.debug(
        ...
        ), s = o.size.x + L, o.size.y = u.size.y - u.size.height / 2 + b * (x + C) + x / 2 + C, Ot.debug(
      ...
      o.children && kt(o), r += o?.widthInColumns ?? 1, Ot.debug("abc88 columnsPos", o, r);
    }
  }
  Ot.debug(
...
function Ut(e2) {
  ...
  if (!t)
    return;
  ot(t, e2, 0, 0), kt(t), Ot.debug("getBlocks", JSON.stringify(t, null, 2));
...
q(ft, "applyStyle");
function jt(e2) {
  const t = bn(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), a = t.append("xhtml:div"), n2 = e2.label, i = e2.isNode ? "nodeLabel" : "edgeLabel", r = a.append("span");
...
q(jt, "addHtmlLabel");
var sr = q(async (e2, t, a, n2) => {
  let i = e2 || "";
  if (typeof i == "object" && (i = i[0]), jr(An().flowchart.htmlLabels)) {
    i = i.replace(/\\n|\n/g, "<br />"), Ot.debug("vertexText" + i);
    const r = await rY(Nc(i)), s = {
      isNode: n2,
      label: r,
...
var It = q((e2, t, a, n2, i, r) => {
  const s = nr[a];
  if (!s) {
    Ot.warn(`Unknown arrow type: ${a}`);
    return;
  }
...
var M = {};
var lr = q(async (e2, t) => {
  const a = An(), n2 = jr(a.flowchart.htmlLabels), i = t.labelType === "markdown" ? xl(
    e2,
    t.label,
    {
      style: t.labelStyle,
...
function tt(e2, t) {
  An().flowchart.htmlLabels && e2 && (e2.style.width = t.length * 9 + "px", e2.style.height = "12px");
}
q(tt, "setTerminalWidth");
var or = q((e2, t) => {
  Ot.debug("Moving label abc88 ", e2.id, e2.label, wt[e2.id], t);
  let a = t.updatedPath ? t.updatedPath : t.originalPath;
  const n2 = An(), { subGraphTitleTotalMargin: i } = FC(n2);
  if (e2.label) {
    const r = wt[e2.id];
    let s = e2.x, l2 = e2.y;
    if (a) {
      const o = ds.calcLabelPosition(a);
      Ot.debug(
  ...
  if (e2.startLabelLeft) {
    ...
    let s = e2.x, l2 = e2.y;
    if (a) {
      const o = ds.calcTerminalLabelPosition(e2.arrowTypeStart ? 10 : 0, "start_left", a);
      s = o.x, l2 = o.y;
    }
  ...
  if (e2.startLabelRight) {
    ...
    let s = e2.x, l2 = e2.y;
    if (a) {
      const o = ds.calcTerminalLabelPosition(
  ...
  if (e2.endLabelLeft) {
    ...
    let s = e2.x, l2 = e2.y;
    if (a) {
      const o = ds.calcTerminalLabelPosition(e2.arrowTypeEnd ? 10 : 0, "end_left", a);
      s = o.x, l2 = o.y;
    }
    r.attr("transform", `translate(${s}, ${l2})`);
  }
  if (e2.endLabelRight) {
    ...
    let s = e2.x, l2 = e2.y;
    if (a) {
      const o = ds.calcTerminalLabelPosition(e2.arrowTypeEnd ? 10 : 0, "end_right", a);
      s = o.x, l2 = o.y;
    }
    r.attr("transform", `translate(${s}, ${l2})`);
  }
...
var dr = q((e2, t, a) => {
  Ot.debug(`intersection calc abc89:
  ...
  if (Math.abs(i - t.y) * s > Math.abs(n2 - t.x) * o) {
    ...
    return l2 === 0 && (f.x = t.x, f.y = t.y), h === 0 && (f.x = t.x), u === 0 && (f.y = t.y), Ot.debug(`abc89 topp/bott calc, Q ${u}, q ${x}, R ${h}, r ${l2}`, f), f;
  } else {
    a.x < t.x ? l2 = t.x - s - n2 : l2 = n2 - s - t.x;
    let x = u * l2 / h, f = a.x < t.x ? a.x + h - l2 : a.x - h + l2, b = a.y < t.y ? a.y + x : a.y - x;
    return Ot.debug(`sides calc abc89, Q ${u}, q ${x}, R ${h}, r ${l2}`, { _x: f, _y: b }), l2 === 0 && (f = t.x, b = t.y), h === 0 && (f = t.x), u === 0 && (b = t.y), { x: f, y: b };
  }
}, "intersection");
var Bt = q((e2, t) => {
  Ot.debug("abc88 cutPathAtIntersect", e2, t);
...
var hr = q(function(e2, t, a, n2, i, r, s) {
  let l2 = a.points;
  Ot.debug("abc88 InsertEdge: edge=", a, "e=", t);
  let o = false;
  const u = r.node(t.v);
  var h = r.node(t.w);
  h?.intersect && u?.intersect && (l2 = l2.slice(1, a.points.length - 1), l2.unshift(u.intersect(l2[0])), l2.push(h.intersect(l2[l2.length - 1]))), a.toCluster && (Ot.debug("to cluster abc88", n2[a.toCluster]), l2 = Bt(a.points, n2[a.toCluster].node), o = true), a.fromCluster && (Ot.debug("from cluster abc88", n2[a.fromCluster]), l2 = Bt(l2.reverse(), n2[a.fromCluster].node).reverse(), o = true);
  const x = l2.filter((c) => !Number.isNaN(c.y));
  let f = X1;
  a.curve && (i === "graph" || i === "flowchart") && (f = a.curve);
  const { x: b, y: L } = l4t(a), S = zwt().x(b).y(L).curve(f);
  let k;
  switch (a.thickness) {
    case "normal":
  ...
  let D = "";
  (An().flowchart.arrowMarkerAbsolute || An().state.arrowMarkerAbsolute) && (D = TU(true)), ir(T, a, D, s, i);
  let v = {};
...
q(Zt, "intersectEllipse");
var qt = Zt;
function Vt(e2, t, a) {
  return qt(e2, t, t, a);
}
q(Vt, "intersectCircle");
var pr = Vt;
...
var R = q(async (e2, t, a, n2) => {
  const i = An();
  let r;
  const s = t.useHtmlLabels || jr(i.flowchart.htmlLabels);
  ...
  let f = x.getBBox();
  const b = t.padding / 2;
  if (jr(i.flowchart.htmlLabels)) {
    const L = x.children[0], S = bn(x), k = L.getElementsByTagName("img");
    if (k) {
...
q(U, "insertPolygonShape");
var mr = q(async (e2, t) => {
  t.useHtmlLabels || An().flowchart.htmlLabels || (t.centerLabel = true);
...
var Lr = mr;
var Ot2 = q((e2) => e2 ? " " + e2 : "", "formatClass");
var W = q((e2, t) => `${t || "node default"}${Ot2(e2.classes)} ${Ot2(
  e2.class
)}`, "getClassesFromNode");
var zt = q(async (e2, t) => {
  ...
  Ot.info("Question main (Circle)");
  const o = U(a, s, s, l2);
  return o.attr("style", t.style), $(t, o), t.intersect = function(u) {
    return Ot.warn("Intersect called"), N.polygon(t, l2, u);
  }, a;
}, "question");
var Sr = q((e2, t) => {
...
var Ir = q(async (e2, t) => {
  ...
  if (r.attr("class", "basic label-container").attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("x", o).attr("y", u).attr("width", s).attr("height", l2), t.props) {
    ...
    t.props.borders && (ct(r, t.props.borders, s, l2), h.delete("borders")), h.forEach((x) => {
      Ot.warn(`Unknown node property ${x}`);
    });
  }
...
var Or = q(async (e2, t) => {
  ...
  if (n2.attr("width", i).attr("height", r), a.attr("class", "label edgeLabel"), t.props) {
    ...
    t.props.borders && (ct(n2, t.props.borders, i, r), s.delete("borders")), s.forEach((l2) => {
      Ot.warn(`Unknown node property ${l2}`);
    });
  }
...
function ct(e2, t, a, n2) {
  ...
  t.includes("t") ? (Ot.debug("add top border"), r(a)) : s(a), t.includes("r") ? (Ot.debug("add right border"), r(n2)) : s(n2), t.includes("b") ? (Ot.debug("add bottom border"), r(a)) : s(a), t.includes("l") ? (Ot.debug("add left border"), r(n2)) : s(n2), e2.attr("stroke-dasharray", i.join(" "));
}
q(ct, "applyNodePropertyBorders");
var zr = q(async (e2, t) => {
  let a;
  ...
  let o = "";
  typeof l2 == "object" ? o = l2[0] : o = l2, Ot.info("Label text abc79", o, l2, typeof l2 == "object");
  const u = s.node().appendChild(await K(o, t.labelStyle, true, true));
  let h = { width: 0, height: 0 };
  if (jr(An().flowchart.htmlLabels)) {
    const S = u.children[0], k = bn(u);
...
var Ar = q(async (e2, t) => {
  ...
  return r.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n2.width / 2 + i).attr("width", n2.width + t.padding).attr("height", n2.height + t.padding), Ot.info("Circle main"), $(t, r), t.intersect = function(s) {
    return Ot.info("Circle intersect", t, n2.width / 2 + i, s), N.circle(t, n2.width / 2 + i, s);
  }, a;
}, "circle");
var Mr = q(async (e2, t) => {
  const { shapeSvg: a, bbox: n2, halfPadding: i } = await R(
  ...
  return s.attr("class", t.class), l2.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n2.width / 2 + i + r).attr("width", n2.width + t.padding + r * 2).attr("height", n2.height + t.padding + r * 2), o.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n2.width / 2 + i).attr("width", n2.width + t.padding).attr("height", n2.height + t.padding), Ot.info("DoubleCircle main"), $(t, l2), t.intersect = function(u) {
    return Ot.info("DoubleCircle intersect", t, n2.width / 2 + i + r, u), N.circle(t, n2.width / 2 + i + r, u);
  }, a;
}, "doublecircle");
var Pr = q(async (e2, t) => {
  const { shapeSvg: a, bbox: n2 } = await R(
...
var Xr = q(async (e2, t) => {
  ...
  t.classData.type !== void 0 && t.classData.type !== "" && (An().flowchart.htmlLabels ? D += "&lt;" + t.classData.type + "&gt;" : D += "<" + t.classData.type + ">");
  const v = f.node().appendChild(await K(D, t.labelStyle, true, true));
  bn(v).attr("class", "classTitle");
  let c = v.getBBox();
  if (jr(An().flowchart.htmlLabels)) {
    const d = v.children[0], _ = bn(v);
  ...
  t.classData.members.forEach(async (d) => {
    ...
    An().flowchart.htmlLabels && (y2 = y2.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
    ...
    let O = A.getBBox();
    if (jr(An().flowchart.htmlLabels)) {
      const q2 = A.children[0], j = bn(A);
      O = q2.getBoundingClientRect(), j.attr("width", O.width), j.attr("height", O.height);
    }
...
var nt = {};
var Qt = q(async (e2, t, a) => {
  let n2, i;
  if (t.link) {
    let r;
    An().securityLevel === "sandbox" ? r = "_top" : t.linkTarget && (r = t.linkTarget || "_blank"), n2 = e2.insert("svg:a").attr("xlink:href", t.link).attr("target", r), i = await At[t.shape](n2, t, a);
  } else
...
function Et(e2, t, a = false) {
  ...
  const o = TX(n2?.styles ?? []), u = n2.label, h = n2.size ?? { width: 0, height: 0, x: 0, y: 0 };
  return {
    ...
    intersect: void 0,
    type: n2.type,
    padding: l2 ?? Gi()?.block?.padding ?? 0
  };
}
q(Et, "getNodeFromBlock");
async function te(e2, t, a) {
  const n2 = Et(t, a, false);
  if (n2.type === "group")
    return;
  const i = Gi(), r = await Qt(e2, n2, { config: i }), s = r.node().getBBox(), l2 = a.getBlock(n2.id);
  l2.size = { width: s.width, height: s.height, x: 0, y: 0, node: r }, a.setBlock(l2), r.remove();
}
q(te, "calculateBlockSize");
...
q(se, "insertEdges");
var Fr = q(function(e2, t) {
  return t.db.getClasses();
}, "getClasses");
var Ur = q(async function(e2, t, a, n2) {
  const { securityLevel: i, block: r } = Gi(), s = n2.db;
  let l2;
  i === "sandbox" && (l2 = bn("#i" + t));
  const o = i === "sandbox" ? bn(l2.nodes()[0].contentDocument.body) : bn("body"), u = i === "sandbox" ? o.select(`[id="${t}"]`) : bn(`[id="${t}"]`);
  ...
  if (await ae(b, h, s), await se(b, f, x, s, t), L) {
    ...
    LU(u, T, D, !!v), Ot.debug("Here Bounds", L, S), u.attr(
      "viewBox",
...
//# sourceMappingURL=blockDiagram-6J76NXCF-CKU6xA4s-D8REXnmR-MOLJNQLL.js.map
