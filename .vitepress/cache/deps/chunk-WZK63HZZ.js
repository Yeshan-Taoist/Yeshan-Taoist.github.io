...
// node_modules/vitepress-plugin-legend/dist/chunk-OW32GOEJ-YaixIGDO-OV7DQY6p.js
var Dt = (function() {
  var t = q(function(w, r, a2, y) {
    ...
    performAction: q(function(w, r, a2, y, m, i, $2) {
      var l = i.length - 1;
      switch (m) {
        case 3:
...
` + this.showPosition(), {
      ...
      performAction: q(function(r, a2, y, m) {
        switch (y) {
          case 0:
            return 38;
          case 1:
  ...
  return q(lt, "Parser"), lt.prototype = gt, gt.Parser = lt, new lt();
})();
Dt.parser = Dt;
var Fe = Dt;
var de = "TB";
...
var Ae = q(function(t, e) {
  return e.db.getClasses();
}, "getClasses");
var Oe = q(async function(t, e, o, s) {
  Ot.info("REF0:"), Ot.info("Drawing state diagram (v2)", e);
  const { securityLevel: d, state: h, layout: f } = An();
  s.db.extract(s.db.getRootDocV2());
  const S = s.db.getData(), n = a(e, d);
  S.type = s.type, S.layoutAlgorithm = f, S.nodeSpacing = h?.nodeSpacing || 50, S.rankSpacing = h?.rankSpacing || 50, S.markers = ["barb"], S.diagramId = e, await Rle(S, n);
  const g = 8;
  try {
    (typeof s.db.getLinks == "function" ? s.db.getLinks() : /* @__PURE__ */ new Map()).forEach((L, b) => {
      ...
      if (!D) {
        Ot.warn("⚠️ Invalid or missing stateId from key:", JSON.stringify(b));
        return;
      }
      ...
      if (O?.forEach((v) => {
        ...
        Ot.warn("⚠️ Could not find node matching text:", D);
        return;
      }
      const C = c.parentNode;
      if (!C) {
        Ot.warn("⚠️ Node has no parent, cannot wrap:", D);
        return;
      }
      ...
      C.replaceChild(k, c), k.appendChild(c), Ot.info("🔗 Wrapped node in <a> tag for:", D, L.url);
    });
  } catch (L) {
    Ot.error("❌ Error injecting clickable links:", L);
  }
  ds.insertTitle(
    n,
...
q(ft, "stateDomId");
var we = q((t, e, o, s, d, h, f, S) => {
  Ot.trace("items", e), e.forEach((n) => {
    switch (n.stmt) {
      case V:
        q2(t, n, o, s, d, h, f, S);
        break;
      ...
      case Ct:
        {
          ...
          const g = {
            ...
            style: Ft,
            labelStyle: "",
            label: Mh.sanitizeText(n.description ?? "", An()),
            arrowheadStyle: Gt,
            labelpos: jt,
            labelType: Ut,
            thickness: Wt,
...
q(J, "insertOrUpdateNode");
function Vt(t) {
  return t?.classes?.join(" ") ?? "";
}
q(Vt, "getClassesFromDbInfo");
function Xt(t) {
  return t?.styles ?? [];
}
q(Xt, "getStylesFromDbInfo");
var q2 = q((t, e, o, s, d, h, f, S) => {
  const n = e.id, g = o.get(n), L = Vt(g), b = Xt(g), D = An();
  if (Ot.info("dataFetcher parsedItem", e, g, b), n !== "root") {
    let O = kt;
    e.start === true ? O = fe : e.start === false && (O = ge), e.type !== Q && (O = e.type), yt.get(n) || yt.set(n, {
      id: n,
      shape: O,
      description: Mh.sanitizeText(n, D),
      cssClasses: `${L} ${Te}`,
      cssStyles: b
    });
    const c = yt.get(n);
    e.description && (Array.isArray(c.description) ? (c.shape = Et, c.description.push(e.description)) : c.description?.length && c.description.length > 0 ? (c.shape = Et, c.description === n ? c.description = [e.description] : c.description = [c.description, e.description]) : (c.shape = kt, c.description = e.description), c.description = Mh.sanitizeTextOrArray(c.description, D)), c.description?.length === 1 && c.shape === Et && (c.type === "group" ? c.shape = Ot2 : c.shape = kt), !c.type && e.doc && (Ot.info("Setting cluster for XCX", n, Rt(e)), c.type = "group", c.isGroup = true, c.dir = Rt(e), c.shape = e.type === Yt ? At : Ot2, c.cssClasses = `${c.cssClasses} ${$e} ${h ? Le : ""}`);
    const C = {
      labelStyle: "",
      shape: c.shape,
      label: c.description,
    ...
    if (C.shape === At && (C.label = ""), t && t.id !== "root" && (Ot.trace("Setting node ", n, " to be child of its parent ", t.id), C.parentId = t.id), C.centerLabel = true, e.note) {
      const k = {
        labelStyle: "",
        shape: Se,
        label: e.note.text,
      ...
      F++, v.id = N, k.parentId = N, J(s, v, S), J(s, k, S), J(s, C, S);
      let P = n, Y = k.id;
  ...
  e.doc && (Ot.trace("Adding nodes children "), we(e, e.doc, o, s, d, !h, f, S));
}, "dataFetcher");
var Re = q(() => {
  yt.clear(), F = 0;
}, "reset");
...
var Nt = q(() => /* @__PURE__ */ new Map(), "newClassesList");
var Bt = q(() => ({
  relations: [],
  states: /* @__PURE__ */ new Map(),
  documents: {}
}), "newDoc");
var ut = q((t) => JSON.parse(JSON.stringify(t)), "clone");
var pt;
var je = (pt = class {
  constructor(t) {
    this.version = t, this.nodes = [], this.edges = [], this.rootDoc = [], this.classes = Nt(), this.documents = { root: Bt() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.dividerCnt = 0, this.links = /* @__PURE__ */ new Map(), this.getAccTitle = Vvt, this.setAccTitle = Uvt, this.getAccDescription = Xvt, this.setAccDescription = Gvt, this.setDiagramTitle = Yvt, this.getDiagramTitle = Kvt, this.clear(), this.setRootDoc = this.setRootDoc.bind(this), this.getDividerId = this.getDividerId.bind(this), this.setDirection = this.setDirection.bind(this), this.trimColon = this.trimColon.bind(this);
  }
  /**
  ...
  setRootDoc(t) {
    Ot.info("Setting root doc", t), this.rootDoc = t, this.version === 1 ? this.extract(t) : this.extract(this.getRootDocV2());
  }
  docTranslator(t, e, o) {
    if (e.stmt === Ct) {
  ...
  addState(t, e = Q, o = void 0, s = void 0, d = void 0, h = void 0, f = void 0, S = void 0) {
    ...
    if (!this.currentDocument.states.has(n))
      Ot.info("Adding state ", n, s), this.currentDocument.states.set(n, {
        stmt: V,
        id: n,
        descriptions: [],
        type: e,
    ...
    if (s && (Ot.info("Setting state description", n, s), (Array.isArray(s) ? s : [s]).forEach((g) => this.addDescription(n, g.trim()))), d) {
      const g = this.currentDocument.states.get(n);
      if (!g)
        throw new Error(`State not found: ${n}`);
      g.note = d, g.note.text = Mh.sanitizeText(g.note.text, An());
    }
    h && (Ot.info("Setting state classes", n, h), (Array.isArray(h) ? h : [h]).forEach((g) => this.setCssClass(n, g.trim()))), f && (Ot.info("Setting state styles", n, f), (Array.isArray(f) ? f : [f]).forEach((g) => this.setStyle(n, g.trim()))), S && (Ot.info("Setting state styles", n, f), (Array.isArray(S) ? S : [S]).forEach((g) => this.setTextStyle(n, g.trim())));
  }
  clear(t) {
    this.nodes = [], this.edges = [], this.documents = { root: Bt() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = Nt(), t || (this.links = /* @__PURE__ */ new Map(), Wvt());
  }
  getState(t) {
  ...
  logDocuments() {
    Ot.info("Documents = ", this.documents);
  }
  getRelations() {
   ...
   */
  addLink(t, e, o) {
    this.links.set(t, { url: e, tooltip: o }), Ot.warn("Adding link", t, e, o);
  }
  /**
  ...
  addRelationObjs(t, e, o = "") {
    ...
    this.addState(
      ...
      id1: s,
      id2: h,
      relationTitle: Mh.sanitizeText(o, An())
    });
  }
  /**
  ...
  addRelation(t, e, o) {
    if (typeof t == "object" && typeof e == "object")
      ...
      this.addState(s, d), this.addState(h, f), this.currentDocument.relations.push({
        id1: s,
        id2: h,
        relationTitle: o ? Mh.sanitizeText(o, An()) : void 0
      });
    }
  }
  addDescription(t, e) {
    const o = this.currentDocument.states.get(t), s = e.startsWith(":") ? e.replace(":", "").trim() : e;
    o?.descriptions?.push(Mh.sanitizeText(s, An()));
  }
  cleanupLabel(t) {
...
//# sourceMappingURL=chunk-WZK63HZZ.js.map
