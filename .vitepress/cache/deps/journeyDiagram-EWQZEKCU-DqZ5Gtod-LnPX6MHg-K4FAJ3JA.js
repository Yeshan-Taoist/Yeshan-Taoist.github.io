...
// node_modules/vitepress-plugin-legend/dist/journeyDiagram-EWQZEKCU-DqZ5Gtod-LnPX6MHg.js
var U = (function() {
  var t = q(function(d2, i, a, u) {
    ...
    performAction: q(function(d2, i, a, u, p, o2, x) {
      var k = o2.length - 1;
      switch (p) {
        case 1:
          return o2[k - 1];
...
` + this.showPosition(), {
      ...
      performAction: q(function(i, a, u, p) {
        switch (u) {
          case 0:
            break;
          case 1:
  ...
  return q(g2, "Parser"), g2.prototype = f, f.Parser = g2, new g2();
})();
U.parser = U;
var Ct = U;
var V = "";
...
var R = [];
var Et = q(function() {
  X.length = 0, F.length = 0, V = "", R.length = 0, Wvt();
}, "clear");
var Tt = q(function(t) {
  V = t, X.push(t);
}, "addSection");
...
var it = {
  getConfig: q(() => An().journey, "getConfig"),
  clear: Et,
  setDiagramTitle: Yvt,
  getDiagramTitle: Kvt,
  setAccTitle: Uvt,
...
`, "getStyles");
var Rt = Ft;
var Q = q(function(t, e) {
  return o(t, e);
}, "drawRect");
var Lt = q(function(t, e) {
  ...
  return q(c, "ambivalent"), e.score > 3 ? n(l2) : e.score < 3 ? y(l2) : c(l2), r;
}, "drawFace");
var ot = q(function(t, e) {
...
var ct = (function() {
  ...
  return q(l2, "_setTextAttrs"), function(n) {
...
var N = 0;
function ht(t) {
  const e = An().journey, r = e.maxLabelWidth;
  N = 0;
  let l2 = 60;
...
q(ht, "drawActorLegend");
var S = An().journey;
var E = 0;
var Gt = q(function(t, e, r, l2) {
  const n = An(), y = n.journey.titleColor, c = n.journey.titleFontSize, h2 = n.journey.titleFontFamily, f = n.securityLevel;
  let m;
  f === "sandbox" && (m = bn("#i" + e));
  const g2 = f === "sandbox" ? bn(m.nodes()[0].contentDocument.body) : bn("body");
  v.init();
  ...
  LU(d2, x, k, S.useMaxWidth), d2.append("line").attr("x1", E).attr("y1", S.height * 4).attr("x2", k - E - 4).attr("y2", S.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  const T = a ? 70 : 0;
...
var v = {
  ...
  updateVal: q(function(t, e, r, l2) {
    t[e] === void 0 ? t[e] = r : t[e] = l2(r, t[e]);
  }, "updateVal"),
  updateBounds: q(function(t, e, r, l2) {
    const n = An().journey, y = this;
    let c = 0;
    function h2(f) {
      return q(function(m) {
        c++;
    ...
    q(h2, "updateFn"), this.sequenceItems.forEach(h2());
  }, "updateBounds"),
  insert: q(function(t, e, r, l2) {
...
//# sourceMappingURL=journeyDiagram-EWQZEKCU-DqZ5Gtod-LnPX6MHg-K4FAJ3JA.js.map
