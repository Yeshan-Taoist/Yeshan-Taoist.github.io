...
// node_modules/vitepress-plugin-legend/dist/linear-m73w_WNc-FCrKOMM3.js
function g(t, n) {
...
function w(t, n) {
  var u = typeof n, e;
  return n == null || u === "boolean" ? jC(n) : (u === "number" ? Ua : u === "string" ? (e = qd(n)) ? (n = e, ZT) : h5t : n instanceof qd ? ZT : n instanceof Date ? S : L(n) ? H : Array.isArray(n) ? Q : typeof n.valueOf != "function" && typeof n.toString != "function" || isNaN(n) ? U : Ua)(t, n);
}
function W(t, n) {
...
function rt() {
  ...
  return l.invert = function(s) {
    return o(a2((r || (r = i(n, t.map(e), Ua)))(s)));
  }, l.domain = function(s) {
...
//# sourceMappingURL=chunk-GF3TSUIW.js.map
