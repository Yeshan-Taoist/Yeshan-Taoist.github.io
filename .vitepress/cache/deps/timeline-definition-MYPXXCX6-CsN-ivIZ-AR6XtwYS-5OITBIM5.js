...
// node_modules/vitepress-plugin-legend/dist/timeline-definition-MYPXXCX6-CsN-ivIZ-AR6XtwYS.js
var U = (function() {
  var n = q(function(g, i, c, d) {
    ...
    performAction: q(function(g, i, c, d, u, o, m) {
      var k = o.length - 1;
      switch (u) {
        case 1:
          return o[k - 1];
    ...
    parse: q(function(g) {
      ...
      for (var v, A, T, Z, O = {}, F, I, K, W; ; ) {
        if (A = c[c.length - 1], this.defaultActions[A] ? T = this.defaultActions[A] : ((v === null || typeof v > "u") && (v = J()), T = m[A] && m[A][v]), typeof T > "u" || !T.length || !T[0]) {
          ...
          x.showPosition ? q2 = "Parse error on line " + (N + 1) + `:
` + x.showPosition() + `
Expecting ` + W.join(", ") + ", got '" + (this.terminals_[v] || v) + "'" : q2 = "Parse error on line " + (N + 1) + ": Unexpected " + (v == C ? "end of input" : "'" + (this.terminals_[v] || v) + "'"), this.parseError(q2, {
            text: x.match,
...
` + this.showPosition(), {
      ...
      performAction: q(function(i, c, d, u) {
        switch (d) {
          case 0:
            break;
          case 1:
  ...
  return q(b, "Parser"), b.prototype = f, f.Parser = b, new b();
})();
U.parser = U;
var St = U;
var it = {};
...
var B = [];
var z = [];
var at = q(() => BU, "getCommonDb");
var ot = q(function() {
  Y.length = 0, B.length = 0, j = "", z.length = 0, Wvt();
}, "clear");
var ct = q(function(n) {
  j = n, Y.push(n);
}, "addSection");
...
var Nt = q(function(n, t) {
  ...
  return q(h, "ambivalent"), t.score > 3 ? s(a) : t.score < 3 ? l(a) : h(a), e;
}, "drawFace");
var Ct = q(function(n, t) {
...
var gt = (function() {
  ...
  return q(a, "_setTextAttrs"), function(s) {
...
function Q(n, t) {
  n.each(function() {
    var e = bn(this), a = e.text().split(/(\s+|<br>)/).reverse(), s, l = [], h = 1.1, y = e.attr("y"), p = parseFloat(e.attr("dy")), f = e.text(null).append("tspan").attr("x", 0).attr("y", y).attr("dy", p + "em");
...
q(Q, "wrap");
var Ot2 = q(function(n, t, e, a) {
  const s = e % Tt - 1, l = n.append("g");
  t.section = s, l.attr(
    "class",
...
var Dt = q(function(n, t, e, a) {
  const s = An(), l = s.timeline?.leftMargin ?? 50;
  Ot.debug("timeline", a.db);
  const h = s.securityLevel;
  let y;
  h === "sandbox" && (y = bn("#i" + t));
  const p = (h === "sandbox" ? bn(y.nodes()[0].contentDocument.body) : bn("body")).select("#" + t);
  p.append("g");
  const f = a.db.getTasks(), _ = a.db.getCommonDb().getDiagramTitle();
  Ot.debug("task", f), M.initGraphics(p);
  ...
  b.forEach(function(C) {
    ...
    Ot.debug("sectionHeight before draw", x), g = Math.max(g, x + 20);
  });
  let N = 0, P = 0;
  Ot.debug("tasks.length", f.length);
  for (const [C, w] of f.entries()) {
    ...
    Ot.debug("taskHeight before draw", S), i = Math.max(i, S + 20), N = Math.max(N, w.events.length);
    let H = 0;
  ...
  Ot.debug("maxSectionHeight before draw", g), Ot.debug("maxTaskHeight before draw", i), b && b.length > 0 ? b.forEach((C) => {
    ...
    Ot.debug("sectionNode", x);
    const S = p.append("g"), H = M.drawNode(S, x, m, s);
    Ot.debug("sectionNode output", H), S.attr("transform", `translate(${u}, ${d})`), o += g + 50, w.length > 0 && st(
      p,
      w,
      m,
      u,
  ...
  Ot.debug("bounds", D), _ && p.append("text").text(_).attr("x", D.width / 2 - l).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), c = k ? g + i + 150 : i + 100, p.append("g").attr("class", "lineWrapper").append("line").attr("x1", l).attr("y1", c).attr("x2", D.width + 3 * l).attr("y2", c).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), Rvt(
    void 0,
    p,
...
var st = q(function(n, t, e, a, s, l, h, y, p, f, _) {
  for (const b of t) {
    const g = {
      descr: b.task,
      section: e,
    ...
    if (Ot.debug("taskHeight after draw", c), i.attr("transform", `translate(${a}, ${s})`), l = Math.max(l, c), b.events) {
...
var Rt = q((n) => {
  ...
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
    n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], _f(n["lineColor" + e]) ? n["lineColor" + e] = pe(n["lineColor" + e], 20) : n["lineColor" + e] = Se(n["lineColor" + e], 20);
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
    const a = "" + (17 - 3 * e);
    t += `
...
//# sourceMappingURL=timeline-definition-MYPXXCX6-CsN-ivIZ-AR6XtwYS-5OITBIM5.js.map
