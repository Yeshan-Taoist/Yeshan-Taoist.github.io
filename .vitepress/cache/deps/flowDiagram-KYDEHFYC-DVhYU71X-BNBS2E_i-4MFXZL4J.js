...
import {
  a
} from "./chunk-PJPHXOZX.js";
import {
  $
} from "./chunk-QYJTKBNV.js";
import {
  An,
  Gvt,
  Kvt,
...
// node_modules/vitepress-plugin-legend/dist/flowDiagram-KYDEHFYC-DVhYU71X-BNBS2E_i.js
var ht = "flowchart-";
var te;
var dt = (te = class {
  // cspell:ignore funs
  constructor() {
    this.vertexCounter = 0, this.config = An(), this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = true, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = Uvt, this.setAccDescription = Gvt, this.setDiagramTitle = Yvt, this.getAccTitle = Vvt, this.getAccDescription = Xvt, this.getDiagramTitle = Kvt, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = {
      firstGraph: this.firstGraph.bind(this)
    }, this.clear(), this.setGen("gen-2");
  }
  sanitizeText(e2) {
    return Mh.sanitizeText(e2, this.config);
  }
  /**
...
` + l2 + `
    ...
    if (g === void 0 && (g = {
      ...
      styles: [],
      classes: []
    }, this.vertices.set(e2, g)), this.vertexCounter++, i !== void 0 ? (this.config = An(), F = this.sanitizeText(i.text.trim()), g.labelType = i.type, F.startsWith('"') && F.endsWith('"') && (F = F.substring(1, F.length - 1)), g.text = F) : g.text === void 0 && (g.text = e2), r !== void 0 && (g.type = r), n?.forEach((D) => {
      g.styles.push(D);
    }), a2?.forEach((D) => {
      g.classes.push(D);
  ...
  addSingleLink(e2, i, r, n) {
    ...
    if (p !== void 0 && (a2.text = this.sanitizeText(p.text.trim()), a2.text.startsWith('"') && a2.text.endsWith('"') && (a2.text = a2.text.substring(1, a2.text.length - 1)), a2.labelType = p.type), r !== void 0 && (a2.type = r.type, a2.stroke = r.stroke, a2.length = r.length > 10 ? 10 : r.length), n && !this.edges.some((d) => d.id === n))
      ...
      d.length === 0 ? a2.id = vle(a2.start, a2.end, { counter: 0, prefix: "L" }) : a2.id = vle(a2.start, a2.end, {
        counter: d.length + 1,
        prefix: "L"
      });
    }
    if (this.edges.length < (this.config.maxEdges ?? 500))
      Ot.info("Pushing edge..."), this.edges.push(a2);
    else
      throw new Error(
...
You have to call mermaid.initialize.`
  ...
  setClickFun(e2, i, r) {
    ...
    if (An().securityLevel !== "loose" || i === void 0)
      return;
    let a2 = [];
    if (typeof r == "string") {
      a2 = r.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
  ...
  setLink(e2, i, r) {
    e2.split(",").forEach((n) => {
      ...
      a2 !== void 0 && (a2.link = ds.formatUrl(i, this.config), a2.linkTarget = r);
  ...
  setupToolTips(e2) {
    let i = bn(".mermaidTooltip");
    (i._groups || i)[0][0] === null && (i = bn("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), bn(e2).select("svg").selectAll("g.node").on("mouseover", (r) => {
      const n = bn(r.currentTarget);
      ...
      i.transition().duration(500).style("opacity", 0), bn(r.currentTarget).classed("hover", false);
    });
  }
  /**
   ...
   */
  clear(e2 = "gen-2") {
    this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = true, this.version = e2, this.config = An(), Wvt();
  }
  setGen(e2) {
  ...
  addSubGraph(e2, i, r) {
    ...
    let l2 = p.dir;
    const c = An().flowchart ?? {};
    if (l2 = l2 ?? (c.inheritDir ? this.getDirection() ?? An().direction ?? void 0 : void 0), this.version === "gen-1")
    ...
    return Ot.info("Adding", f.id, f.nodes, f.dir), f.nodes = this.makeUniq(f, this.subGraphs).nodes, this.subGraphs.push(f), this.subGraphLookup.set(n, f), n;
  }
  getPosForId(e2) {
  ...
  getData() {
    const e2 = An(), i = [], r = [], n = this.getSubGraphs(), a2 = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map();
    ...
    return d.forEach((l2, c) => {
      ...
      const D = {
        id: vle(l2.start, l2.end, { counter: c, prefix: "L" }, l2.id),
        ...
        arrowTypeEnd: l2?.stroke === "invisible" || l2?.type === "arrow_open" ? "none" : F,
  ...
  defaultConfig() {
    return ole.flowchart;
  }
}, q(te, "FlowDB"), te);
var pt = q(function(e2, i) {
  return i.db.getClasses();
}, "getClasses");
var gt = q(async function(e2, i, r, n) {
  Ot.info("REF0:"), Ot.info("Drawing state diagram (v2)", i);
  const { securityLevel: a2, flowchart: p, layout: d } = An();
  let l2;
  a2 === "sandbox" && (l2 = bn("#i" + i));
  const c = a2 === "sandbox" ? l2.nodes()[0].contentDocument : document;
  Ot.debug("Before getData: ");
  const f = n.db.getData();
  Ot.debug("Data: ", f);
  const F = a(i, a2), g = n.db.getDirection();
  f.type = n.type, f.layoutAlgorithm = jle(d), f.layoutAlgorithm === "dagre" && d === "elk" && Ot.warn(
    "flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."
  ), f.direction = g, f.nodeSpacing = p?.nodeSpacing || 50, f.rankSpacing = p?.rankSpacing || 50, f.markers = ["point", "circle", "cross"], f.diagramId = i, Ot.debug("REF1:", f), await Rle(f, F);
  ...
  ), $(F, D, "flowchart", p?.useMaxWidth || false);
  for (const z of f.nodes) {
    const A = bn(`#${i} [id="${z.id}"]`);
    if (!A || !z.link)
      continue;
...
var ie = (function() {
  var e2 = q(function(Y, o, h, u) {
    ...
    performAction: q(function(Y, o, h, u, C, t, j) {
      var s = t.length - 1;
      switch (C) {
        case 2:
          this.$ = [];
...
` + this.showPosition(), {
      ...
      options: {},
      performAction: q(function(o, h, u, C) {
        switch (u) {
          case 0:
  ...
  return q(z1, "Parser"), z1.prototype = X1, X1.Parser = z1, new z1();
})();
ie.parser = ie;
var Oe = ie;
...
var Tt = {
  ...
  styles: yt,
  init: q((e2) => {
    e2.flowchart || (e2.flowchart = {}), e2.layout && ile({ layout: e2.layout }), e2.flowchart.arrowMarkerAbsolute = e2.arrowMarkerAbsolute, ile({ flowchart: { arrowMarkerAbsolute: e2.arrowMarkerAbsolute } });
  }, "init")
};
export {
  Tt as diagram
};
//# sourceMappingURL=flowDiagram-KYDEHFYC-DVhYU71X-BNBS2E_i-4MFXZL4J.js.map
